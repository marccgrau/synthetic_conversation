...
user_prompt = """
    ...
    - **Structure**:
        ...
        - Indication that the issue requires follow-up or cannot be resolved during the call
        - Agent offers further assistance, Client declines, Agent thanks the Client and ends the call.
    ...
    **Callback Note Requirements**:
    ...
    - message: Summary of the call script indicating the unresolved issue and need for further follow-up (for internal documentation)
    - resolved_items: null
    - action_items: {topic}
    - wants_callback: true
