...
user_prompt = """
    ...
    - **Struktur**:
        ...
        - Der Agent fragt, ob weitere Hilfe benötigt wird, der Kunde lehnt ab, der Agent bedankt sich beim Kunden und beendet das Gespräch.
    ...
    **Anforderungen an die Rückrufnotiz**:
    ...
    - message: Zusammenfassung der Kundenanfrage und Lösung (nur für interne Dokumentation)
