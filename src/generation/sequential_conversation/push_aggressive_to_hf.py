...
def main():
    ...
    input_directory = "agentic_simulation_outputs/aggressive"
    output_file = "aggressive_conversations_dataset.jsonl"
    ...
    repo_name = "marccgrau/agentic_synthetic_aggressive_conversations"
