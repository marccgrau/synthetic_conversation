...
def main():
    ...
    input_directory = "agentic_simulation_outputs/default/filtered_conversations"
    output_file = "huggingface_outputs/llm_filtered_conversations_dataset.jsonl"
    ...
    repo_name = "marccgrau/llm_filtered_customer_service_conversations"
